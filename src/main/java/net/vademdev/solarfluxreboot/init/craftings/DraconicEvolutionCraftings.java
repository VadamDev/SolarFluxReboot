...
public class DraconicEvolutionCraftings implements ICraftingHandler {
    ...
    public void registerShapedRecipies() {
        ...
        GameRegistry.addRecipe(new ItemStack(ModItems.chaotic_energy_core, 1), new Object[] {
                "aea",
                "ece",
                "aea",
        ...
        //--------Solar Panel--------
        GameRegistry.addRecipe(new ItemStack(ModBlocks.solarMap.get(SolarTier.TIER_WYVERN), 2), new Object[] {
                "ses",
                "ece",
                "ses",
        ...
        GameRegistry.addRecipe(new ItemStack(ModBlocks.solarMap.get(SolarTier.TIER_DRACONIC), 2), new Object[] {
                "ses",
                "ece",
                "ses",
        ...
        GameRegistry.addRecipe(new ItemStack(ModBlocks.solarMap.get(SolarTier.TIER_CHAOTIC), 2), new Object[] {
                "sas",
                "aca",
                "sas",
